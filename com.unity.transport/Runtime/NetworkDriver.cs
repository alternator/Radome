...
namespace Unity.Networking.Transport
{
    ...
    /// <summary>
    /// The BasicNetworkDriver is a simple implementaiton of Virtual Connections over any transport.
    ///
    /// Basic usage:
    /// <code>
    /// var driver = new BasicNetworkDriver&lt;IPv4UDPSocket&gt;(new INetworkParameter[0]);
    /// </code>
    /// </summary>
    ...
    public struct BasicNetworkDriver<T> : INetworkDriver, INetworkPacketReceiver where T : struct, INetworkInterface
    {
        ...
        /// <summary>
        /// The Concurrent struct is used to create an Concurrent instance of the BasicNetworkDriver.
        /// </summary>
...
#pragma warning restore 649
        ...
        public NetworkEndPoint RemoteEndPoint(NetworkConnection id)
        {
			...
			return m_ConnectionList[id.m_NetworkId].Address;
		}
