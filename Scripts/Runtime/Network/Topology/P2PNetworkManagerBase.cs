...
//		{
//			var packet = new NativeStreamWriter(14 + _ActivePlayerIdList.Count + MyPlayerInfo.PacketSize, Allocator.Temp);

//			var defferredLen = packet.WriteUShort((ushort)0);
//			packet.WriteByte((byte)BuiltInPacket.Type.RegisterPlayer);
//			packet.WriteUShort(id);
//			packet.WriteLong(LeaderStatTime);
//			packet.WriteByte((byte)(isReconnect ? 1 : 0));

//			packet.WriteByte((byte)_ActivePlayerIdList.Count);
...
//		{
//			var packet = new NativeStreamWriter(11, Allocator.Temp);
//			var defferredLen = packet.Write((ushort)0);
